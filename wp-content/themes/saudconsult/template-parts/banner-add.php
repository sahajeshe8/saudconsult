...
$dark_class = isset($args['dark']) && $args['dark'] ? 'dark' : '';

?>

<section class="ready_to_partner_section pt_80 pb_80 banner-add-section <?php echo esc_attr($dark_class); ?>"
	data-desktop-bg="<?php echo esc_url($background_image); ?>" <?php if ($mobile_image): ?>data-mobile-bg="<?php echo esc_url($mobile_image); ?>" <?php endif; ?>
	...
	<div class="wrap">
		...
		<?php if ($description): ?>
			<p data-aos="fade-up" data-aos-duration="800" data-aos-delay="100"><?php echo wp_kses_post($description); ?>
			</p>
		<?php endif; ?>

		<?php if ($button_text && $button_link): ?>
			<a class="btn_style btn_transparent short" href="<?php echo esc_url($button_link); ?>" data-aos="fade-up"
				data-aos-duration="800" data-aos-delay="200">
				<?php echo esc_html($button_text); ?> <span><img
						src="<?php echo get_template_directory_uri(); ?>/assets/images/buttion-arrow.svg"
						alt="<?php echo esc_attr($button_text); ?>"></span>
			</a>
		<?php endif; ?>
	</div>
</section>