 ...
 * Content is managed via ACF Flexible Content (About Section Pages). Empty sections are hidden.
 * Download Company Profile button uses PDF from Company Options. WPML-ready.
 *
 * @package tasheel
 */
...
<main id="primary" class="site-main">
	...
	$current_slug  = $current_page ? $current_page->post_name : 'overview';
	$current_id    = $current_page ? (int) $current_page->ID : 0;
	$page_tabs_data = array(
		'tabs'            => tasheel_about_subpage_tabs(),
		'active_tab'      => $current_slug,
		'active_page_id'  => $current_id,
	);
