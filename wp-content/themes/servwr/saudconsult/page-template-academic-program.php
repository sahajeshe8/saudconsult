 ...
 *
 * The template for the Academic Program page. Content is driven by ACF Flexible Content.
	...
	if ( function_exists( 'get_field' ) && function_exists( 'tasheel_render_careers_flexible_section' ) ) {
		...
		if ( ! empty( $sections ) && is_array( $sections ) ) {
			...
			$inner_banner_data = array(
				...
				'title'            => esc_html__( 'Academic Program', 'tasheel' ),
			);
