...
$faq_heading_first = isset( $args['faq_heading_first'] ) ? $args['faq_heading_first'] : '';
$faq_heading_span  = isset( $args['faq_heading_span'] ) ? $args['faq_heading_span'] : '';
if ( $faq_heading_first === '' ) {
	$faq_heading_first = esc_html__( 'Frequently', 'tasheel' );
}
if ( $faq_heading_span === '' ) {
	$faq_heading_span = esc_html__( 'Asked Questions', 'tasheel' );
}
?>
		...
		<div class="faq_wrapper">
			<?php if ( ! empty( $faq_items ) ) : ?>
				<h3 class="h3_title_50">
					<?php echo esc_html( $faq_heading_first ); ?>
					<span><?php echo esc_html( $faq_heading_span ); ?></span>
				</h3>
