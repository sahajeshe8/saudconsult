...
// Strip any auto-added <p> tags from ACF so we don't show literal tags; we wrap in a single <p> below.
...
<section class="ready_to_partner_section pt_80 pb_80 banner-add-section" 
	...
	<div class="wrap">
		...
		<?php if ( $description ) : ?>
			<p class="banner-add-description" data-aos="fade-up" data-aos-duration="800" data-aos-delay="100"><?php echo esc_html( $description ); ?></p>
		<?php endif; ?>
