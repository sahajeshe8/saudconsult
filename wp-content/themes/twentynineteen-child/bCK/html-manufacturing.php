      ...
      <div class="content-sec d-flx">
         <div class="content dot-list">
            ...
            <div data-sr="wait 0.1s, enter right">
               <p>A state-of-the- art formulation manufacturing facility complying with global regulatory norms to manufacture  pharmaceutical Products such as:</p>
            </div>
            <ul class="col-02">
...
<section style="background: #f8fcff;" class=" pt-130">
   <div class="wrap">
      <div class="state-block-1 dot-list  ">
         ...
         <div data-sr="wait 0.1s, enter right">
            <p>a.	Line 1-U1<br>
               A state-of-art formulation manufacturing facility complying with C-Gmp norms to manufacture pharmaceutical Products such as:
            </p>
         </div>
         <ul>
      ...
      <div class="state-block-2 d-flx w-100">
         <div class="left-side mt-50" data-sr="wait 0.1s, enter right">
      ...
      <div class="state-block-3 d-flx flx-align-center pb-20">
         <div class="left-side dot-list">
            <div data-sr="wait 0.1s, enter right">
               <p>b. Line 2 -U2 <br>A state-of-art formulation manufacturing facility complying with C-Gmp norms to manufacture pharmaceutical exclusively for:</p>
            </div>
            <ul>
               <li data-sr="wait 0.1s, enter right">Sterile ophthalmic ointments/gels, </li>
               <li data-sr="wait 0.1s, enter right">Sterile General Ointments/gels, and </li>
               <li data-sr="wait 0.1s, enter right">Sterile prefilled syringes (For external Use)</li>
            </ul>
         </div>
         <div class="right-side w-3">
            <div class="slider-block-01 slider-block-02 border-blue arrow-style ">
               <div class="slider-sec logo-slider-2 swiper-container over-flow-true style ">
                  <div class="swiper-wrapper"  >
                     <div class="swiper-slide">
                        <div class="logo-block-01">
                           <div class="icon">
                     ...
                     <div class="swiper-slide">
                        <div class="logo-block-01">
                           ...
                           <p>High Quality made in europe</p>
                        </div>
                     </div>
      ...
      <div class="content-block align-center pb-80 pt-110" data-sr="wait 0.1s, enter right">
