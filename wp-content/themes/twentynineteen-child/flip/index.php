						...
						<figure>
							<picture>
								...
								<div class="first-article-content">
									<time class="article-publish-time secondary_font"><strong>Date published:</strong> <?php echo date('F jS, Y',strtotime(get_the_date())); ?></time>
											...
											<figure>
												<picture>
													...
													<div class="post-list-content">
														<time class="article-publish-time secondary_font"><strong><?php _e('Date published:'); ?></strong> <?php echo date('F jS, Y',strtotime(get_the_date())); ?></time>
														<h4><?php the_title(); ?></h4>
														<p><?php echo wp_trim_words(get_field('short_description'),12,'') ?></p>
														<a href="<?php the_permalink(); ?>" class="read-more-btn"><?php _e('Read this article...'); ?></a>
													</div>
