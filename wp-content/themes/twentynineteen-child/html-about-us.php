...
jQuery('.main-nav > ul :nth-child(2)').addClass("active");
...
An Integrated Pharma Company</h2>
 ...
 In addition, we offer a board range of services such as contract R&D, CDMO, CMO, manufacturing and distribution of products.</p>
<p>We have now embarked on a new journey in the developed nations, taking nascent steps such as in-licensing/ acquiring of products and front-end marketing capabilities.
...
<!-- <?php  //echo do_shortcode("[rev_slider alias='video'][/rev_slider]"); ?> -->

<div class="presentation-block rel">


<a href="<?php echo site_url('/corporate-presentation/');?>"  ><span href="<?php echo site_url('/corporate-presentation/');?>" class="but-01 mx-auto">Corporate Presentation</span><img   src="<?php echo get_stylesheet_directory_uri(); ?>/images/presentation-banner.jpg"></a>
</div>
<div class="but-row- flx-row pt-30">

<!-- <a href="<?php //echo site_url('/corporate-presentation/');?>" class="but-01 mx-auto">Corporate Presentation</a> -->
</div>
</div>
    </div>
...
<section class="mb-100"> 
  ...
  <div class="career-title-row align-center"  data-sr="wait 0.1s, enter right" >
            ...
            <p>
            Regent Group has a widespread supply chain across 30+ countries with a key focus on USA, Europe, and<br>Emerging markets by virtue of its trading business.
            </p>
          ...
          <div class="milestone-block mt-50">
             <ul class="milestone-ul">
              <li>
                ...
                <div class="milstone-txt-01"  data-sr="wait 0.03s, enter right" >
                  <p>Emerging as a fully
integrated global
pharmaceutical player</p> 
                </div>
              </li>
              <li>
                <div class="milstone-block-01"  data-sr="wait 0.03s, enter right" >
                  <div class="minls-icn"><img   src="<?php echo get_stylesheet_directory_uri(); ?>/images/mile-icn-02.png"></div>
                  <h3>2019</h3>
                </div>
                <div class="milstone-txt-01"  data-sr="wait 0.03s, enter right" >
                  <p>Established 3rd overseas
office in Mauritius</p> 
                </div>
              </li>
              ...
              <li>
                ...
                <div class="milstone-txt-01"  data-sr="wait 0.03s, enter right" >
                  <p>Established 2<sup>nd</sup> overseas (scientific) office in Vietnam, to strengthen
Asia-pacific operations</p> 
              ...
              <li>
                ...
                <div class="milstone-txt-01"  data-sr="wait 0.03s, enter right" >
                  <p>Established 1<sup>st</sup> overseas office in Singapore</p> 
                </div>
              </li>
...
Started exporting pharmaceutical products to over 30 countries</p> 
                </div>
              </li>
              ...
              <li>
                ...
                <div class="milstone-txt-01"  data-sr="wait 0.03s, enter right" >
                  <p>Established base in UAE</p> 
                </div>
              </li>

              <li>
                <div class="milstone-block-01"  data-sr="wait 0.03s, enter right" >
                  <div class="minls-icn"><img   src="<?php echo get_stylesheet_directory_uri(); ?>/images/mile-icn-11.png"></div>
                  <h3>2003</h3>
                </div>
                <div class="milstone-txt-01"  data-sr="wait 0.03s, enter right" >
                  <p>Commenced international pharmaceutical trading</p> 
                </div>
              </li>
