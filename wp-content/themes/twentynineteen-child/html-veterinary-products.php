   ...
   <div class="wrap">
      <div class="title-block-vet-main">
         ...
         <ul class="veterinary-block">
            <li class="vet-temp-1">
               <div data-sr="wait 0.1s, enter right" class="vent-img-main  rel">
            ...
            <li class="row-reverce vet-temp-2">
               <div class="vent-img-main  rel" data-sr="wait 0.1s, enter right">
                  <h2>Safe<br>
                     Heart
                  </h2>
                  <img class="mx-100" src=" <?php echo get_stylesheet_directory_uri(); ?>/images/rgt-veterinary-img2.png" alt="image">
               </div>
               <div class="vent-txt-main">
                  <div class="vent-title-block" data-sr="wait 0.1s, enter right">
